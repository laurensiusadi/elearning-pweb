                ...
                <form class="form" role="form" method="POST" action="{{ url('role').'/'.$role->id }}">
                    <div class="box-body">
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            ...
                            <input type="text" class="form-control" name="name" placeholder="Nama Role" value="{{ $role->name }}">
                        ...
                        <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                            ...
                            <textarea type="text" class="form-control" name="description" placeholder="Deskripsi">{{ $role->description }}</textarea>
