    ...
    <div class="row">
        <div class="col-md-8">
            <div class="box box-primary">
                ...
                <form class="form" role="form" method="POST" action="{{ url('period') }}">
                    <div class="box-body">
                        {!! csrf_field() !!}
                        ...
                        <div class="form-group{{ $errors->has('semester') ? ' has-error' : '' }}">
                            ...
                            <input type="text" class="form-control" name="semester" placeholder="Semester" value="{{ old('semester') }}">
                        ...
                        <div class="form-group{{ $errors->has('mulai') ? ' has-error' : '' }}">
                            ...
                            <div class="input-group date">
                            	...
                            	<input type="date" class="form-control pull-right" name="mulai" value="{{ old('mulai') }}"></input>
                            </div>
                        ...
                        <div class="form-group{{ $errors->has('selesai') ? ' has-error' : '' }}">
                            ...
                            <div class="input-group date">
                            	...
                            	<input type="date" class="form-control pull-right" name="selesai" value="{{ old('selesai') }}"></input>
                            </div>
